...
public class ApproachOrLane {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        ApproachOrLane_u.layout().withName("choice"),
        asn_struct_ctx_s.layout().withName("_asn_ctx")
    ).withName("ApproachOrLane");
     ...
     * }
     */
    public static class ApproachOrLane_u {
