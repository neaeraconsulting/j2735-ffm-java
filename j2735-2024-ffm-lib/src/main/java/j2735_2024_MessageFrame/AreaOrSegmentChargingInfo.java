 ...
 * }
 */
public class AreaOrSegmentChargingInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        AreaOrSegmentChargingInfo__chargingAreaOrSegment.layout().withName("chargingAreaOrSegment"),
        asn_struct_ctx_s.layout().withName("_asn_ctx")
    ).withName("AreaOrSegmentChargingInfo");
     ...
     * }
     */
    public static class AreaOrSegmentChargingInfo__chargingAreaOrSegment {

        AreaOrSegmentChargingInfo__chargingAreaOrSegment() {
            // Should not be called directly
        }
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            ...
            asn_struct_ctx_s.layout().withName("_asn_ctx")
        ).withName("AreaOrSegmentChargingInfo__chargingAreaOrSegment");
    ...
    private static final GroupLayout chargingAreaOrSegment$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("chargingAreaOrSegment"));

    /**
     * Layout for field:
     * {@snippet lang=c :
     * struct AreaOrSegmentChargingInfo__chargingAreaOrSegment chargingAreaOrSegment
     * }
     */
    public static final GroupLayout chargingAreaOrSegment$layout() {
        return chargingAreaOrSegment$LAYOUT;
    }

    private static final long chargingAreaOrSegment$OFFSET = 0;
     ...
     * }
     */
    public static final long chargingAreaOrSegment$offset() {
        return chargingAreaOrSegment$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment chargingAreaOrSegment(MemorySegment struct) {
        return struct.asSlice(chargingAreaOrSegment$OFFSET, chargingAreaOrSegment$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void chargingAreaOrSegment(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, chargingAreaOrSegment$OFFSET, chargingAreaOrSegment$LAYOUT.byteSize());
    }
