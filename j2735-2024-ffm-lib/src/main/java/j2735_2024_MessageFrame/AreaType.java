...
public class AreaType {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        AreaType_u.layout().withName("choice"),
     ...
     * }
     */
    public static class AreaType_u {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            BroadRegion.layout().withName("broadRegion"),
            PathList.layout().withName("paths")
        ).withName("AreaType_u");
        ...
        private static final GroupLayout broadRegion$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("broadRegion"));
         ...
         * }
         */
        public static final GroupLayout broadRegion$layout() {
            return broadRegion$LAYOUT;
        }

        private static final long broadRegion$OFFSET = 0;
         ...
         * }
         */
        public static final long broadRegion$offset() {
            return broadRegion$OFFSET;
        }
         ...
         * }
         */
        public static MemorySegment broadRegion(MemorySegment union) {
            return union.asSlice(broadRegion$OFFSET, broadRegion$LAYOUT.byteSize());
        }
         ...
         * }
         */
        public static void broadRegion(MemorySegment union, MemorySegment fieldValue) {
            MemorySegment.copy(fieldValue, 0L, union, broadRegion$OFFSET, broadRegion$LAYOUT.byteSize());
        }
        ...
        private static final long paths$OFFSET = 0;
         ...
         * }
         */
        public static MemorySegment paths(MemorySegment union) {
            return union.asSlice(paths$OFFSET, paths$LAYOUT.byteSize());
        }
         ...
         * }
         */
        public static void paths(MemorySegment union, MemorySegment fieldValue) {
            MemorySegment.copy(fieldValue, 0L, union, paths$OFFSET, paths$LAYOUT.byteSize());
        }
