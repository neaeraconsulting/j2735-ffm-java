...
public class BasicSafetyMessage {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        BSMcoreData.layout().withName("coreData"),
        MessageFrame_h.C_POINTER.withName("partII"),
        MessageFrame_h.C_POINTER.withName("regional"),
        asn_struct_ctx_s.layout().withName("_asn_ctx")
    ).withName("BasicSafetyMessage");
    ...
    private static final GroupLayout coreData$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("coreData"));
     ...
     * }
     */
    public static final GroupLayout coreData$layout() {
        return coreData$LAYOUT;
    }

    private static final long coreData$OFFSET = 0;
     ...
     * }
     */
    public static final long coreData$offset() {
        return coreData$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment coreData(MemorySegment struct) {
        return struct.asSlice(coreData$OFFSET, coreData$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void coreData(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, coreData$OFFSET, coreData$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static class BasicSafetyMessage__partII {

        BasicSafetyMessage__partII() {
            // Should not be called directly
        }
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            ...
            asn_struct_ctx_s.layout().withName("_asn_ctx")
        ).withName("BasicSafetyMessage__partII");
    ...
    private static final AddressLayout partII$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("partII"));

    /**
     * Layout for field:
     * {@snippet lang=c :
     * struct BasicSafetyMessage__partII *partII
     * }
     */
    public static final AddressLayout partII$layout() {
        return partII$LAYOUT;
    }

    private static final long partII$OFFSET = 392;
     ...
     * }
     */
    public static final long partII$offset() {
        return partII$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment partII(MemorySegment struct) {
        return struct.get(partII$LAYOUT, partII$OFFSET);
    }
     ...
     * }
     */
    public static void partII(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(partII$LAYOUT, partII$OFFSET, fieldValue);
    }
     ...
     * }
     */
    public static class BasicSafetyMessage__regional {

        BasicSafetyMessage__regional() {
            // Should not be called directly
        }
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            list.layout().withName("list"),
            asn_struct_ctx_s.layout().withName("_asn_ctx")
        ).withName("BasicSafetyMessage__regional");
     ...
     * Layout for field:
     * {@snippet lang=c :
     * struct BasicSafetyMessage__regional *regional
     * }
     */
    ...
    private static final long regional$OFFSET = 400;
