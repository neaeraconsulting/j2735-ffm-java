 ...
 * }
 */
public class CommonSafetyRequest {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MessageFrame_h.C_POINTER.withName("msgCnt"),
        MessageFrame_h.C_POINTER.withName("id"),
        RequestedItemList.layout().withName("requests"),
        MessageFrame_h.C_POINTER.withName("regional"),
        asn_struct_ctx_s.layout().withName("_asn_ctx")
    ).withName("CommonSafetyRequest");
    ...
    private static final AddressLayout msgCnt$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("msgCnt"));
     ...
     * }
     */
    public static final AddressLayout msgCnt$layout() {
        return msgCnt$LAYOUT;
    }

    private static final long msgCnt$OFFSET = 8;
     ...
     * }
     */
    public static MemorySegment msgCnt(MemorySegment struct) {
     ...
     * }
     */
    public static void msgCnt(MemorySegment struct, MemorySegment fieldValue) {
     ...
     * }
     */
    public static class CommonSafetyRequest__regional {

        CommonSafetyRequest__regional() {
            // Should not be called directly
        }
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            ...
            asn_struct_ctx_s.layout().withName("_asn_ctx")
        ).withName("CommonSafetyRequest__regional");
     ...
     * Layout for field:
     * {@snippet lang=c :
     * struct CommonSafetyRequest__regional *regional
     * }
     */
