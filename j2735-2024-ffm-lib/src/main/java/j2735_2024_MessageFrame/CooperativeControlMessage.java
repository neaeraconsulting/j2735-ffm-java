...
/**
 * {@snippet lang=c :
 * struct CooperativeControlMessage {
 ...
 * }
 */
public class CooperativeControlMessage {
    ...
    ).withName("CooperativeControlMessage");
     ...
     * }
     */
    public static class CooperativeControlMessage__partII {

        CooperativeControlMessage__partII() {
            // Should not be called directly
        }
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            ...
            asn_struct_ctx_s.layout().withName("_asn_ctx")
        ).withName("CooperativeControlMessage__partII");
     ...
     * Layout for field:
     * {@snippet lang=c :
     * struct CooperativeControlMessage__partII *partII
     * }
     */
    ...
    private static final long _asn_ctx$OFFSET = 400;
