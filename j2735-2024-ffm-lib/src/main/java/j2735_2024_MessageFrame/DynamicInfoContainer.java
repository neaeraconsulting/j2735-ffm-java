 ...
 * }
 */
public class DynamicInfoContainer {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        DynamicInfoContainer__dmsSignString.layout().withName("dmsSignString"),
        RegionInfo.layout().withName("applicableRegion"),
        asn_struct_ctx_s.layout().withName("_asn_ctx")
    ).withName("DynamicInfoContainer");
     ...
     * }
     */
    public static class DynamicInfoContainer__dmsSignString {

        DynamicInfoContainer__dmsSignString() {
            // Should not be called directly
        }
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            ...
            asn_struct_ctx_s.layout().withName("_asn_ctx")
        ).withName("DynamicInfoContainer__dmsSignString");
    ...
    private static final GroupLayout dmsSignString$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("dmsSignString"));

    /**
     * Layout for field:
     * {@snippet lang=c :
     * struct DynamicInfoContainer__dmsSignString dmsSignString
     * }
     */
    public static final GroupLayout dmsSignString$layout() {
        return dmsSignString$LAYOUT;
    }

    private static final long dmsSignString$OFFSET = 8;
     ...
     * }
     */
    public static final long dmsSignString$offset() {
        return dmsSignString$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment dmsSignString(MemorySegment struct) {
        return struct.asSlice(dmsSignString$OFFSET, dmsSignString$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void dmsSignString(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, dmsSignString$OFFSET, dmsSignString$LAYOUT.byteSize());
    }
    ...
    private static final long applicableRegion$OFFSET = 56;
