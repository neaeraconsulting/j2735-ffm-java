...
public class IncidentsContainer {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        RegionInfo.layout().withName("incidentLocation"),
        asn_struct_ctx_s.layout().withName("_asn_ctx")
    ).withName("IncidentsContainer");
     ...
     * }
     */
    public static class IncidentsContainer__responderType {

        IncidentsContainer__responderType() {
            // Should not be called directly
        }
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            ...
            asn_struct_ctx_s.layout().withName("_asn_ctx")
        ).withName("IncidentsContainer__responderType");
     ...
     * Layout for field:
     * {@snippet lang=c :
     * struct IncidentsContainer__responderType *responderType
     * }
     */
    ...
    private static final long responderType$OFFSET = 0;
    ...
    private static final GroupLayout incidentLocation$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("incidentLocation"));
     ...
     * }
     */
    public static final GroupLayout incidentLocation$layout() {
        return incidentLocation$LAYOUT;
    }

    private static final long incidentLocation$OFFSET = 8;
     ...
     * }
     */
    public static final long incidentLocation$offset() {
        return incidentLocation$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment incidentLocation(MemorySegment struct) {
        return struct.asSlice(incidentLocation$OFFSET, incidentLocation$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void incidentLocation(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, incidentLocation$OFFSET, incidentLocation$LAYOUT.byteSize());
    }
