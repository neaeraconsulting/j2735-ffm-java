...
public class IntersectionGeometry {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        LaneList.layout().withName("laneSet"),
        MessageFrame_h.C_POINTER.withName("preemptPriorityData"),
        MessageFrame_h.C_POINTER.withName("regional"),
        MessageFrame_h.C_POINTER.withName("roadAuthorityID"),
        asn_struct_ctx_s.layout().withName("_asn_ctx")
    ).withName("IntersectionGeometry");
    ...
    private static final GroupLayout laneSet$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("laneSet"));
     ...
     * }
     */
    public static final GroupLayout laneSet$layout() {
        return laneSet$LAYOUT;
    }

    private static final long laneSet$OFFSET = 128;
     ...
     * }
     */
    public static final long laneSet$offset() {
        return laneSet$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment laneSet(MemorySegment struct) {
        return struct.asSlice(laneSet$OFFSET, laneSet$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void laneSet(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, laneSet$OFFSET, laneSet$LAYOUT.byteSize());
    }

    private static final AddressLayout preemptPriorityData$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("preemptPriorityData"));
     ...
     * }
     */
    public static final AddressLayout preemptPriorityData$layout() {
        return preemptPriorityData$LAYOUT;
    }

    private static final long preemptPriorityData$OFFSET = 176;
     ...
     * }
     */
    public static final long preemptPriorityData$offset() {
        return preemptPriorityData$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment preemptPriorityData(MemorySegment struct) {
        return struct.get(preemptPriorityData$LAYOUT, preemptPriorityData$OFFSET);
    }
     ...
     * }
     */
    public static void preemptPriorityData(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(preemptPriorityData$LAYOUT, preemptPriorityData$OFFSET, fieldValue);
    }
     ...
     * }
     */
    public static class IntersectionGeometry__regional {

        IntersectionGeometry__regional() {
            // Should not be called directly
        }
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            ...
            asn_struct_ctx_s.layout().withName("_asn_ctx")
        ).withName("IntersectionGeometry__regional");
     ...
     * Layout for field:
     * {@snippet lang=c :
     * struct IntersectionGeometry__regional *regional
     * }
     */
