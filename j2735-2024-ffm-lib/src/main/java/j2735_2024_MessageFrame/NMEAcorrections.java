...
public class NMEAcorrections {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MessageFrame_h.C_POINTER.withName("rev"),
        MessageFrame_h.C_POINTER.withName("msg"),
        MessageFrame_h.C_POINTER.withName("wdCount"),
        OCTET_STRING.layout().withName("payload"),
        MessageFrame_h.C_POINTER.withName("regional"),
        asn_struct_ctx_s.layout().withName("_asn_ctx")
    ).withName("NMEAcorrections");
    ...
    private static final AddressLayout rev$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("rev"));
     ...
     * }
     */
    public static final AddressLayout rev$layout() {
        return rev$LAYOUT;
    }
     ...
     * }
     */
    public static MemorySegment rev(MemorySegment struct) {
     ...
     * }
     */
    public static void rev(MemorySegment struct, MemorySegment fieldValue) {
    ...
    private static final long msg$OFFSET = 16;
    ...
    private static final AddressLayout wdCount$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("wdCount"));
     ...
     * }
     */
    public static final AddressLayout wdCount$layout() {
        return wdCount$LAYOUT;
    }

    private static final long wdCount$OFFSET = 24;
     ...
     * }
     */
    public static final long wdCount$offset() {
        return wdCount$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment wdCount(MemorySegment struct) {
        return struct.get(wdCount$LAYOUT, wdCount$OFFSET);
    }
     ...
     * }
     */
    public static void wdCount(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(wdCount$LAYOUT, wdCount$OFFSET, fieldValue);
    }
     ...
     * }
     */
    public static class NMEAcorrections__regional {

        NMEAcorrections__regional() {
            // Should not be called directly
        }
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            ...
            asn_struct_ctx_s.layout().withName("_asn_ctx")
        ).withName("NMEAcorrections__regional");
     ...
     * Layout for field:
     * {@snippet lang=c :
     * struct NMEAcorrections__regional *regional
     * }
     */
