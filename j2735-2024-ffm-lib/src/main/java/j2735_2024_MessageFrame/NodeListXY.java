...
public class NodeListXY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        NodeListXY_u.layout().withName("choice"),
     ...
     * }
     */
    public static class NodeListXY_u {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            NodeSetXY.layout().withName("nodes"),
            ComputedLane.layout().withName("computed")
        ).withName("NodeListXY_u");
         ...
         * }
         */
        public static MemorySegment nodes(MemorySegment union) {
            return union.asSlice(nodes$OFFSET, nodes$LAYOUT.byteSize());
        }
         ...
         * }
         */
        public static void nodes(MemorySegment union, MemorySegment fieldValue) {
            MemorySegment.copy(fieldValue, 0L, union, nodes$OFFSET, nodes$LAYOUT.byteSize());
        }

        private static final GroupLayout computed$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("computed"));
         ...
         * }
         */
        public static final GroupLayout computed$layout() {
            return computed$LAYOUT;
        }

        private static final long computed$OFFSET = 0;
         ...
         * }
         */
        public static final long computed$offset() {
         ...
         * }
         */
        public static MemorySegment computed(MemorySegment union) {
            return union.asSlice(computed$OFFSET, computed$LAYOUT.byteSize());
        }
         ...
         * }
         */
        public static void computed(MemorySegment union, MemorySegment fieldValue) {
            MemorySegment.copy(fieldValue, 0L, union, computed$OFFSET, computed$LAYOUT.byteSize());
        }
