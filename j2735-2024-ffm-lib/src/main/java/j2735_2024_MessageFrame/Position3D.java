...
public class Position3D {
    ...
    private static final long lat$OFFSET = 0;
     ...
     * }
     */
    public static class Position3D__regional {

        Position3D__regional() {
            // Should not be called directly
        }
     ...
     * Layout for field:
     * {@snippet lang=c :
     * struct Position3D__regional *regional
     * }
     */
