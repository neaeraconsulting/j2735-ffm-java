 ...
 * }
 */
public class Reg_BasicSafetyMessage {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Reg_BasicSafetyMessage__regExtValue.layout().withName("regExtValue"),
        asn_struct_ctx_s.layout().withName("_asn_ctx")
    ).withName("Reg_BasicSafetyMessage");
     ...
     * }
     */
    public static class Reg_BasicSafetyMessage__regExtValue {

        Reg_BasicSafetyMessage__regExtValue() {
            // Should not be called directly
        }

        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            MessageFrame_h.C_INT.withName("present"),
            Reg_BasicSafetyMessage__regExtValue_u.layout().withName("choice"),
            MemoryLayout.paddingLayout(4),
            asn_struct_ctx_s.layout().withName("_asn_ctx")
        ).withName("Reg_BasicSafetyMessage__regExtValue");
         ...
         * }
         */
        public static class Reg_BasicSafetyMessage__regExtValue_u {

            Reg_BasicSafetyMessage__regExtValue_u() {
                // Should not be called directly
            }

            private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(

            ).withName("Reg_BasicSafetyMessage__regExtValue_u");
         ...
         * Layout for field:
         * {@snippet lang=c :
         * union Reg_BasicSafetyMessage__regExtValue_u choice
         * }
         */
     ...
     * Layout for field:
     * {@snippet lang=c :
     * struct Reg_BasicSafetyMessage__regExtValue regExtValue
     * }
     */
