 ...
 * }
 */
public class Reg_EventDescription {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Reg_EventDescription__regExtValue.layout().withName("regExtValue"),
        asn_struct_ctx_s.layout().withName("_asn_ctx")
    ).withName("Reg_EventDescription");
     ...
     * }
     */
    public static class Reg_EventDescription__regExtValue {

        Reg_EventDescription__regExtValue() {
            // Should not be called directly
        }

        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            MessageFrame_h.C_INT.withName("present"),
            Reg_EventDescription__regExtValue_u.layout().withName("choice"),
            MemoryLayout.paddingLayout(4),
            asn_struct_ctx_s.layout().withName("_asn_ctx")
        ).withName("Reg_EventDescription__regExtValue");
         ...
         * }
         */
        public static class Reg_EventDescription__regExtValue_u {

            Reg_EventDescription__regExtValue_u() {
                // Should not be called directly
            }

            private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(

            ).withName("Reg_EventDescription__regExtValue_u");
         ...
         * Layout for field:
         * {@snippet lang=c :
         * union Reg_EventDescription__regExtValue_u choice
         * }
         */
     ...
     * Layout for field:
     * {@snippet lang=c :
     * struct Reg_EventDescription__regExtValue regExtValue
     * }
     */
