 ...
 * }
 */
public class Reg_NodeOffsetPointLL {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Reg_NodeOffsetPointLL__regExtValue.layout().withName("regExtValue"),
        asn_struct_ctx_s.layout().withName("_asn_ctx")
    ).withName("Reg_NodeOffsetPointLL");
     ...
     * }
     */
    public static class Reg_NodeOffsetPointLL__regExtValue {

        Reg_NodeOffsetPointLL__regExtValue() {
            // Should not be called directly
        }

        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            MessageFrame_h.C_INT.withName("present"),
            Reg_NodeOffsetPointLL__regExtValue_u.layout().withName("choice"),
            MemoryLayout.paddingLayout(4),
            asn_struct_ctx_s.layout().withName("_asn_ctx")
        ).withName("Reg_NodeOffsetPointLL__regExtValue");
         ...
         * }
         */
        public static class Reg_NodeOffsetPointLL__regExtValue_u {

            Reg_NodeOffsetPointLL__regExtValue_u() {
                // Should not be called directly
            }

            private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(

            ).withName("Reg_NodeOffsetPointLL__regExtValue_u");
         ...
         * Layout for field:
         * {@snippet lang=c :
         * union Reg_NodeOffsetPointLL__regExtValue_u choice
         * }
         */
     ...
     * Layout for field:
     * {@snippet lang=c :
     * struct Reg_NodeOffsetPointLL__regExtValue regExtValue
     * }
     */
