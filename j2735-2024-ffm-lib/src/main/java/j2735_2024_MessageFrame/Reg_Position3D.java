...
public class Reg_Position3D {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Reg_Position3D__regExtValue.layout().withName("regExtValue"),
        asn_struct_ctx_s.layout().withName("_asn_ctx")
    ).withName("Reg_Position3D");
     ...
     * }
     */
    public static class Reg_Position3D__regExtValue {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            ...
            Reg_Position3D__regExtValue_u.layout().withName("choice"),
            asn_struct_ctx_s.layout().withName("_asn_ctx")
        ).withName("Reg_Position3D__regExtValue");
         ...
         * }
         */
        public static class Reg_Position3D__regExtValue_u {

            Reg_Position3D__regExtValue_u() {
                // Should not be called directly
            }

            private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
                Position3D_addGrpB.layout().withName("Position3D_addGrpB"),
                Position3D_addGrpC.layout().withName("Position3D_addGrpC")
            ).withName("Reg_Position3D__regExtValue_u");
            ...
            private static final GroupLayout Position3D_addGrpB$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("Position3D_addGrpB"));
             ...
             * }
             */
            public static final GroupLayout Position3D_addGrpB$layout() {
                return Position3D_addGrpB$LAYOUT;
            }

            private static final long Position3D_addGrpB$OFFSET = 0;
             ...
             * }
             */
            public static final long Position3D_addGrpB$offset() {
                return Position3D_addGrpB$OFFSET;
            }
             ...
             * }
             */
            public static MemorySegment Position3D_addGrpB(MemorySegment union) {
                return union.asSlice(Position3D_addGrpB$OFFSET, Position3D_addGrpB$LAYOUT.byteSize());
            }
             ...
             * }
             */
            public static void Position3D_addGrpB(MemorySegment union, MemorySegment fieldValue) {
                MemorySegment.copy(fieldValue, 0L, union, Position3D_addGrpB$OFFSET, Position3D_addGrpB$LAYOUT.byteSize());
            }

            private static final GroupLayout Position3D_addGrpC$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("Position3D_addGrpC"));
             ...
             * }
             */
            public static final GroupLayout Position3D_addGrpC$layout() {
                return Position3D_addGrpC$LAYOUT;
            }

            private static final long Position3D_addGrpC$OFFSET = 0;
             ...
             * }
             */
            public static final long Position3D_addGrpC$offset() {
                return Position3D_addGrpC$OFFSET;
            }
             ...
             * }
             */
            public static MemorySegment Position3D_addGrpC(MemorySegment union) {
                return union.asSlice(Position3D_addGrpC$OFFSET, Position3D_addGrpC$LAYOUT.byteSize());
            }
             ...
             * }
             */
            public static void Position3D_addGrpC(MemorySegment union, MemorySegment fieldValue) {
                MemorySegment.copy(fieldValue, 0L, union, Position3D_addGrpC$OFFSET, Position3D_addGrpC$LAYOUT.byteSize());
            }
         ...
         * Layout for field:
         * {@snippet lang=c :
         * union Reg_Position3D__regExtValue_u choice
         * }
         */
     ...
     * Layout for field:
     * {@snippet lang=c :
     * struct Reg_Position3D__regExtValue regExtValue
     * }
     */
