 ...
 * }
 */
public class Reg_ProbeDataManagement {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Reg_ProbeDataManagement__regExtValue.layout().withName("regExtValue"),
        asn_struct_ctx_s.layout().withName("_asn_ctx")
    ).withName("Reg_ProbeDataManagement");
     ...
     * }
     */
    public static class Reg_ProbeDataManagement__regExtValue {

        Reg_ProbeDataManagement__regExtValue() {
            // Should not be called directly
        }

        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            MessageFrame_h.C_INT.withName("present"),
            Reg_ProbeDataManagement__regExtValue_u.layout().withName("choice"),
            MemoryLayout.paddingLayout(4),
            asn_struct_ctx_s.layout().withName("_asn_ctx")
        ).withName("Reg_ProbeDataManagement__regExtValue");
         ...
         * }
         */
        public static class Reg_ProbeDataManagement__regExtValue_u {

            Reg_ProbeDataManagement__regExtValue_u() {
                // Should not be called directly
            }

            private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(

            ).withName("Reg_ProbeDataManagement__regExtValue_u");
         ...
         * Layout for field:
         * {@snippet lang=c :
         * union Reg_ProbeDataManagement__regExtValue_u choice
         * }
         */
     ...
     * Layout for field:
     * {@snippet lang=c :
     * struct Reg_ProbeDataManagement__regExtValue regExtValue
     * }
     */
