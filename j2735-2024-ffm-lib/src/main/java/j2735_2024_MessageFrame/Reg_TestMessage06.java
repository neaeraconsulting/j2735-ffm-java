 ...
 * }
 */
public class Reg_TestMessage06 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Reg_TestMessage06__regExtValue.layout().withName("regExtValue"),
        asn_struct_ctx_s.layout().withName("_asn_ctx")
    ).withName("Reg_TestMessage06");
     ...
     * }
     */
    public static class Reg_TestMessage06__regExtValue {

        Reg_TestMessage06__regExtValue() {
            // Should not be called directly
        }

        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            MessageFrame_h.C_INT.withName("present"),
            Reg_TestMessage06__regExtValue_u.layout().withName("choice"),
            MemoryLayout.paddingLayout(4),
            asn_struct_ctx_s.layout().withName("_asn_ctx")
        ).withName("Reg_TestMessage06__regExtValue");
         ...
         * }
         */
        public static class Reg_TestMessage06__regExtValue_u {

            Reg_TestMessage06__regExtValue_u() {
                // Should not be called directly
            }

            private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(

            ).withName("Reg_TestMessage06__regExtValue_u");
         ...
         * Layout for field:
         * {@snippet lang=c :
         * union Reg_TestMessage06__regExtValue_u choice
         * }
         */
     ...
     * Layout for field:
     * {@snippet lang=c :
     * struct Reg_TestMessage06__regExtValue regExtValue
     * }
     */
