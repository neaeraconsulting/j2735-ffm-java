 ...
 * }
 */
public class RoadSafetyMessage {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        CommonContainer.layout().withName("commonContainer"),
        RoadSafetyMessage__content.layout().withName("content"),
        asn_struct_ctx_s.layout().withName("_asn_ctx")
    ).withName("RoadSafetyMessage");
    ...
    private static final GroupLayout commonContainer$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("commonContainer"));
     ...
     * }
     */
    public static final GroupLayout commonContainer$layout() {
        return commonContainer$LAYOUT;
    }

    private static final long commonContainer$OFFSET = 0;
     ...
     * }
     */
    public static final long commonContainer$offset() {
        return commonContainer$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment commonContainer(MemorySegment struct) {
        return struct.asSlice(commonContainer$OFFSET, commonContainer$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void commonContainer(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, commonContainer$OFFSET, commonContainer$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static class RoadSafetyMessage__content {

        RoadSafetyMessage__content() {
            // Should not be called directly
        }
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            ...
            asn_struct_ctx_s.layout().withName("_asn_ctx")
        ).withName("RoadSafetyMessage__content");
     ...
     * Layout for field:
     * {@snippet lang=c :
     * struct RoadSafetyMessage__content content
     * }
     */
    ...
    private static final long content$OFFSET = 352;
