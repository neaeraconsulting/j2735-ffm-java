 ...
 * }
 */
public class RoadWeatherUpload {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        RoadWeatherUpload_u.layout().withName("choice"),
        asn_struct_ctx_s.layout().withName("_asn_ctx")
    ).withName("RoadWeatherUpload");
     ...
     * }
     */
    public static class RoadWeatherUpload_u {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            RoadWeatherUpload__vehicleReport.layout().withName("vehicleReport"),
            RwmSnapShot.layout().withName("citizenReport")
        ).withName("RoadWeatherUpload_u");
         ...
         * }
         */
        public static class RoadWeatherUpload__vehicleReport {

            RoadWeatherUpload__vehicleReport() {
                // Should not be called directly
            }
            ...
            private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                ...
                asn_struct_ctx_s.layout().withName("_asn_ctx")
            ).withName("RoadWeatherUpload__vehicleReport");
        ...
        private static final GroupLayout vehicleReport$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("vehicleReport"));

        /**
         * Layout for field:
         * {@snippet lang=c :
         * struct RoadWeatherUpload__vehicleReport vehicleReport
         * }
         */
        public static final GroupLayout vehicleReport$layout() {
            return vehicleReport$LAYOUT;
        }

        private static final long vehicleReport$OFFSET = 0;
         ...
         * }
         */
        public static final long vehicleReport$offset() {
            return vehicleReport$OFFSET;
        }
         ...
         * }
         */
        public static MemorySegment vehicleReport(MemorySegment union) {
            return union.asSlice(vehicleReport$OFFSET, vehicleReport$LAYOUT.byteSize());
        }
         ...
         * }
         */
        public static void vehicleReport(MemorySegment union, MemorySegment fieldValue) {
            MemorySegment.copy(fieldValue, 0L, union, vehicleReport$OFFSET, vehicleReport$LAYOUT.byteSize());
        }

        private static final GroupLayout citizenReport$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("citizenReport"));
         ...
         * }
         */
        public static final GroupLayout citizenReport$layout() {
            return citizenReport$LAYOUT;
        }

        private static final long citizenReport$OFFSET = 0;
         ...
         * }
         */
        public static final long citizenReport$offset() {
            return citizenReport$OFFSET;
        }
         ...
         * }
         */
        public static MemorySegment citizenReport(MemorySegment union) {
            return union.asSlice(citizenReport$OFFSET, citizenReport$LAYOUT.byteSize());
        }
         ...
         * }
         */
        public static void citizenReport(MemorySegment union, MemorySegment fieldValue) {
            MemorySegment.copy(fieldValue, 0L, union, citizenReport$OFFSET, citizenReport$LAYOUT.byteSize());
        }
     ...
     * Layout for field:
     * {@snippet lang=c :
     * union RoadWeatherUpload_u choice
     * }
     */
