...
public class SPAT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        IntersectionStateList.layout().withName("intersections"),
    ...
    private static final GroupLayout intersections$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("intersections"));
     ...
     * }
     */
    public static final GroupLayout intersections$layout() {
        return intersections$LAYOUT;
    }

    private static final long intersections$OFFSET = 16;
    ...
    public static MemorySegment intersections(MemorySegment struct) {
        return struct.asSlice(intersections$OFFSET, intersections$LAYOUT.byteSize());
    }
    ...
    public static void intersections(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, intersections$OFFSET, intersections$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static class SPAT__regional {
     ...
     * Layout for field:
     * {@snippet lang=c :
     * struct SPAT__regional *regional
     * }
     */
