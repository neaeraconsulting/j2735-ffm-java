...
/**
 * {@snippet lang=c :
 * struct SensorDataSharingMessage_PositionOffsetXYZ {
 ...
 * }
 */
public class SensorDataSharingMessage_PositionOffsetXYZ {
    ...
    ).withName("SensorDataSharingMessage_PositionOffsetXYZ");
