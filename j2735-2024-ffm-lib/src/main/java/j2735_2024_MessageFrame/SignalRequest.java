...
public class SignalRequest {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MessageFrame_h.C_LONG.withName("requestID"),
        MessageFrame_h.C_LONG.withName("requestType"),
        IntersectionAccessPoint.layout().withName("inBoundLane"),
        MessageFrame_h.C_POINTER.withName("outBoundLane"),
        MessageFrame_h.C_POINTER.withName("regional"),
        asn_struct_ctx_s.layout().withName("_asn_ctx")
    ).withName("SignalRequest");
    ...
    private static final OfLong requestID$LAYOUT = (OfLong)$LAYOUT.select(groupElement("requestID"));
     ...
     * }
     */
    public static final OfLong requestID$layout() {
        return requestID$LAYOUT;
    }

    private static final long requestID$OFFSET = 40;
     ...
     * }
     */
    public static final long requestID$offset() {
     ...
     * }
     */
    public static long requestID(MemorySegment struct) {
        return struct.get(requestID$LAYOUT, requestID$OFFSET);
    }
     ...
     * }
     */
    public static void requestID(MemorySegment struct, long fieldValue) {
        struct.set(requestID$LAYOUT, requestID$OFFSET, fieldValue);
    }

    private static final OfLong requestType$LAYOUT = (OfLong)$LAYOUT.select(groupElement("requestType"));
     ...
     * }
     */
    public static final OfLong requestType$layout() {
        return requestType$LAYOUT;
    }

    private static final long requestType$OFFSET = 48;
     ...
     * }
     */
    public static final long requestType$offset() {
        return requestType$OFFSET;
    }
     ...
     * }
     */
    public static long requestType(MemorySegment struct) {
        return struct.get(requestType$LAYOUT, requestType$OFFSET);
    }
     ...
     * }
     */
    public static void requestType(MemorySegment struct, long fieldValue) {
        struct.set(requestType$LAYOUT, requestType$OFFSET, fieldValue);
    }

    private static final GroupLayout inBoundLane$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("inBoundLane"));
     ...
     * }
     */
    public static final GroupLayout inBoundLane$layout() {
        return inBoundLane$LAYOUT;
    }

    private static final long inBoundLane$OFFSET = 56;
     ...
     * }
     */
    public static final long inBoundLane$offset() {
        return inBoundLane$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment inBoundLane(MemorySegment struct) {
        return struct.asSlice(inBoundLane$OFFSET, inBoundLane$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void inBoundLane(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, inBoundLane$OFFSET, inBoundLane$LAYOUT.byteSize());
    }

    private static final AddressLayout outBoundLane$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("outBoundLane"));
     ...
     * }
     */
    public static final AddressLayout outBoundLane$layout() {
        return outBoundLane$LAYOUT;
    }

    private static final long outBoundLane$OFFSET = 96;
     ...
     * }
     */
    public static final long outBoundLane$offset() {
        return outBoundLane$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment outBoundLane(MemorySegment struct) {
        return struct.get(outBoundLane$LAYOUT, outBoundLane$OFFSET);
    }
     ...
     * }
     */
    public static void outBoundLane(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(outBoundLane$LAYOUT, outBoundLane$OFFSET, fieldValue);
    }
     ...
     * }
     */
    public static class SignalRequest__regional {

        SignalRequest__regional() {
            // Should not be called directly
        }
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            ...
            asn_struct_ctx_s.layout().withName("_asn_ctx")
        ).withName("SignalRequest__regional");
     ...
     * Layout for field:
     * {@snippet lang=c :
     * struct SignalRequest__regional *regional
     * }
     */
    ...
    private static final long regional$OFFSET = 104;
