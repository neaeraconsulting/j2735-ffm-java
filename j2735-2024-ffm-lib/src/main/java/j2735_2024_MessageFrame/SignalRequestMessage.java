...
public class SignalRequestMessage {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MessageFrame_h.C_POINTER.withName("sequenceNumber"),
        MessageFrame_h.C_POINTER.withName("requests"),
        RequestorDescription.layout().withName("requestor"),
        MessageFrame_h.C_POINTER.withName("regional"),
        asn_struct_ctx_s.layout().withName("_asn_ctx")
    ).withName("SignalRequestMessage");
    ...
    private static final AddressLayout sequenceNumber$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("sequenceNumber"));
     ...
     * }
     */
    public static final AddressLayout sequenceNumber$layout() {
        return sequenceNumber$LAYOUT;
    }

    private static final long sequenceNumber$OFFSET = 16;
    ...
    private static final AddressLayout requests$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("requests"));
     ...
     * }
     */
    public static final AddressLayout requests$layout() {
        return requests$LAYOUT;
    }

    private static final long requests$OFFSET = 24;
    ...
    public static MemorySegment requests(MemorySegment struct) {
        return struct.get(requests$LAYOUT, requests$OFFSET);
    }
    ...
    public static void requests(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(requests$LAYOUT, requests$OFFSET, fieldValue);
    }

    private static final GroupLayout requestor$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("requestor"));
     ...
     * }
     */
    public static final GroupLayout requestor$layout() {
    ...
    public static MemorySegment requestor(MemorySegment struct) {
        return struct.asSlice(requestor$OFFSET, requestor$LAYOUT.byteSize());
    }
    ...
    public static void requestor(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, requestor$OFFSET, requestor$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static class SignalRequestMessage__regional {

        SignalRequestMessage__regional() {
            // Should not be called directly
        }
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            ...
            asn_struct_ctx_s.layout().withName("_asn_ctx")
        ).withName("SignalRequestMessage__regional");
     ...
     * Layout for field:
     * {@snippet lang=c :
     * struct SignalRequestMessage__regional *regional
     * }
     */
    ...
    private static final long regional$OFFSET = 192;
