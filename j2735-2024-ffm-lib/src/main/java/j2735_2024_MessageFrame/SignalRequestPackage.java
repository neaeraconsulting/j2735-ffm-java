...
public class SignalRequestPackage {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        SignalRequest.layout().withName("request"),
    ...
    private static final long minute$OFFSET = 136;
    ...
    private static final long second$OFFSET = 144;
    ...
    private static final long duration$OFFSET = 152;
     ...
     * }
     */
    public static class SignalRequestPackage__regional {

        SignalRequestPackage__regional() {
            // Should not be called directly
        }
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            ...
            asn_struct_ctx_s.layout().withName("_asn_ctx")
        ).withName("SignalRequestPackage__regional");
     ...
     * Layout for field:
     * {@snippet lang=c :
     * struct SignalRequestPackage__regional *regional
     * }
     */
