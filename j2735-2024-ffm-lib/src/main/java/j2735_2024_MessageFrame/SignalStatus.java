...
public class SignalStatus {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        SignalStatusPackageList.layout().withName("sigStatus"),
        MessageFrame_h.C_POINTER.withName("regional"),
        asn_struct_ctx_s.layout().withName("_asn_ctx")
    ).withName("SignalStatus");
    ...
    private static final GroupLayout sigStatus$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("sigStatus"));
     ...
     * }
     */
    public static final GroupLayout sigStatus$layout() {
        return sigStatus$LAYOUT;
    }

    private static final long sigStatus$OFFSET = 48;
     ...
     * }
     */
    public static final long sigStatus$offset() {
        return sigStatus$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment sigStatus(MemorySegment struct) {
        return struct.asSlice(sigStatus$OFFSET, sigStatus$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void sigStatus(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, sigStatus$OFFSET, sigStatus$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static class SignalStatus__regional {

        SignalStatus__regional() {
            // Should not be called directly
        }
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            ...
            asn_struct_ctx_s.layout().withName("_asn_ctx")
        ).withName("SignalStatus__regional");
     ...
     * Layout for field:
     * {@snippet lang=c :
     * struct SignalStatus__regional *regional
     * }
     */
    ...
    private static final long regional$OFFSET = 96;
