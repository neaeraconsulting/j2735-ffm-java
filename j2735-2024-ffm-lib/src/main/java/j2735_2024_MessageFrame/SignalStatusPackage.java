...
public class SignalStatusPackage {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MessageFrame_h.C_POINTER.withName("requester"),
        IntersectionAccessPoint.layout().withName("inboundOn"),
        MessageFrame_h.C_POINTER.withName("outboundOn"),
        MessageFrame_h.C_POINTER.withName("minute"),
        MessageFrame_h.C_POINTER.withName("second"),
        MessageFrame_h.C_POINTER.withName("duration"),
        MessageFrame_h.C_LONG.withName("status"),
        MessageFrame_h.C_POINTER.withName("regional"),
        asn_struct_ctx_s.layout().withName("_asn_ctx")
    ).withName("SignalStatusPackage");
    ...
    private static final AddressLayout requester$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("requester"));
     ...
     * }
     */
    public static final AddressLayout requester$layout() {
        return requester$LAYOUT;
    }

    private static final long requester$OFFSET = 0;
     ...
     * }
     */
    public static final long requester$offset() {
     ...
     * }
     */
    public static MemorySegment requester(MemorySegment struct) {
        return struct.get(requester$LAYOUT, requester$OFFSET);
    }
     ...
     * }
     */
    public static void requester(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(requester$LAYOUT, requester$OFFSET, fieldValue);
    }

    private static final GroupLayout inboundOn$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("inboundOn"));
     ...
     * }
     */
    public static final GroupLayout inboundOn$layout() {
        return inboundOn$LAYOUT;
    }

    private static final long inboundOn$OFFSET = 8;
     ...
     * }
     */
    public static final long inboundOn$offset() {
        return inboundOn$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment inboundOn(MemorySegment struct) {
        return struct.asSlice(inboundOn$OFFSET, inboundOn$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void inboundOn(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, inboundOn$OFFSET, inboundOn$LAYOUT.byteSize());
    }

    private static final AddressLayout outboundOn$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("outboundOn"));
     ...
     * }
     */
    public static final AddressLayout outboundOn$layout() {
        return outboundOn$LAYOUT;
    }

    private static final long outboundOn$OFFSET = 48;
     ...
     * }
     */
    public static final long outboundOn$offset() {
        return outboundOn$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment outboundOn(MemorySegment struct) {
        return struct.get(outboundOn$LAYOUT, outboundOn$OFFSET);
    }
     ...
     * }
     */
    public static void outboundOn(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(outboundOn$LAYOUT, outboundOn$OFFSET, fieldValue);
    }
    ...
    private static final long minute$OFFSET = 56;
    ...
    private static final long second$OFFSET = 64;
    ...
    private static final long status$OFFSET = 80;
     ...
     * }
     */
    public static class SignalStatusPackage__regional {

        SignalStatusPackage__regional() {
            // Should not be called directly
        }
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            ...
            asn_struct_ctx_s.layout().withName("_asn_ctx")
        ).withName("SignalStatusPackage__regional");
     ...
     * Layout for field:
     * {@snippet lang=c :
     * struct SignalStatusPackage__regional *regional
     * }
     */
