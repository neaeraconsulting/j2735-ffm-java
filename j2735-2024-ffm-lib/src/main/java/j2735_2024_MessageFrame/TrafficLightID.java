...
public class TrafficLightID {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        TrafficLightID_u.layout().withName("choice"),
        asn_struct_ctx_s.layout().withName("_asn_ctx")
    ).withName("TrafficLightID");
     ...
     * }
     */
    public static class TrafficLightID_u {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            ...
            ASN__PRIMITIVE_TYPE_s.layout().withName("oid")
        ).withName("TrafficLightID_u");
         ...
         * }
         */
        public static long id(MemorySegment union) {
         ...
         * }
         */
        public static void id(MemorySegment union, long fieldValue) {
        ...
        private static final long oid$OFFSET = 0;
         ...
         * }
         */
        public static MemorySegment oid(MemorySegment union) {
            return union.asSlice(oid$OFFSET, oid$LAYOUT.byteSize());
        }
         ...
         * }
         */
        public static void oid(MemorySegment union, MemorySegment fieldValue) {
            MemorySegment.copy(fieldValue, 0L, union, oid$OFFSET, oid$LAYOUT.byteSize());
        }
