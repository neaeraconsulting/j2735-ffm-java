...
public class TravelerDataFrameNewPartIIIContent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        TravelerDataFrameNewPartIIIContent_u.layout().withName("choice"),
        asn_struct_ctx_s.layout().withName("_asn_ctx")
    ).withName("TravelerDataFrameNewPartIIIContent");
     ...
     * }
     */
    public static class TravelerDataFrameNewPartIIIContent_u {

        TravelerDataFrameNewPartIIIContent_u() {
            // Should not be called directly
        }

        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            FrictionInformation.layout().withName("frictionInfo")
        ).withName("TravelerDataFrameNewPartIIIContent_u");
        ...
        private static final GroupLayout frictionInfo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("frictionInfo"));
         ...
         * }
         */
        public static final GroupLayout frictionInfo$layout() {
            return frictionInfo$LAYOUT;
        }

        private static final long frictionInfo$OFFSET = 0;
         ...
         * }
         */
        public static final long frictionInfo$offset() {
            return frictionInfo$OFFSET;
        }
         ...
         * }
         */
        public static MemorySegment frictionInfo(MemorySegment union) {
            return union.asSlice(frictionInfo$OFFSET, frictionInfo$LAYOUT.byteSize());
        }
         ...
         * }
         */
        public static void frictionInfo(MemorySegment union, MemorySegment fieldValue) {
            MemorySegment.copy(fieldValue, 0L, union, frictionInfo$OFFSET, frictionInfo$LAYOUT.byteSize());
        }
     ...
     * Layout for field:
     * {@snippet lang=c :
     * union TravelerDataFrameNewPartIIIContent_u choice
     * }
     */
