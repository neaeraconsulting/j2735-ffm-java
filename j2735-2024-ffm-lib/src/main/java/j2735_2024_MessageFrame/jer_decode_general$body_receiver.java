...
public class jer_decode_general$body_receiver {
    ...
    private static final MethodHandle UP$MH = TumData_h.upcallHandle(jer_decode_general$body_receiver.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(jer_decode_general$body_receiver.Function fi, Arena arena) {
