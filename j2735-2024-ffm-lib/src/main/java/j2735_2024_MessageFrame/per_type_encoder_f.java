...
public class per_type_encoder_f {
    ...
    private static final MethodHandle UP$MH = TumData_h.upcallHandle(per_type_encoder_f.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(per_type_encoder_f.Function fi, Arena arena) {
